...
$router->put('/api/reviews/{id}', 'reviewController::updateReview', [wrapMiddleware('authenticate')]);



$router->delete('/api/reviews/{id}', 'reviewController::deleteReview', [wrapMiddleware('authenticate')]);
...
$router->post('/api/payments/mpgs/initiate-public', 'paymentController::initiateMPGSPaymentPublic'); // Public endpoint for guest bookings



$router->post('/api/payments/mpgs/initiate', 'paymentController::initiateMPGSPayment', [wrapMiddleware('authenticate')]);



$router->post('/api/payments/mpgs/verify', 'paymentController::verifyMPGSPayment'); // Optional auth - works without authentication for redirect flow



$router->post('/api/payments/mpgs/notification', 'paymentController::mpgsNotification'); // Public endpoint for MPGS webhook



$router->get('/api/payments/mpgs/config', 'paymentController::getMPGSConfig'); // Public endpoint for frontend config





// Payment routes - OmanNet



$router->post('/api/payments/omanNet/initiate', 'paymentController::initiateOmanNetPayment'); // Public endpoint - no authentication required



$router->post('/api/payments/omanNet/verify', 'paymentController::verifyOmanNetPayment'); // Optional auth - works without authentication for redirect flow



$router->post('/api/payments/omanNet/response', 'paymentController::omanNetResponse'); // Public endpoint for OmanNet response



$router->get('/api/payments/omanNet/config', 'paymentController::getOmanNetConfig'); // Public endpoint for frontend config
