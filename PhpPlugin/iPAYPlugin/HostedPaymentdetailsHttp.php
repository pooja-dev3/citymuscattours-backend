...
<table width="100%" height="100%" cellpadding="1" cellspacing="1">
	...
	<tr>
		<td>
			...
			<input type="hidden" name="tokenflag" value="<?PHP print $tokenflag ; ?>">
			<input type="hidden" name="tokenNum" value="<?PHP print $tokenNum ; ?>">
			...
			<TABLE width="50%" cellpadding="1" cellspacing="1" border="1" align="center">
				...
				<TR>
					...
					<TD colspan="1"><?PHP print $action ; ?></TD>
				</TR>
				<TR>
