...
<FORM name="form1" ACTION="IVRVbVTranPipeBuy.php" METHOD="POST">
...
<TABLE align=center border=1  bordercolor=black>
	<TR>
		...
		<TD>
			...
			<option value="12"> 12 - Token De-Registration </option>
			</select>
		</TD>
    </TR>
   ...
   <TR>
	...
	<TR>
		...
		<TR>
		<TD >Amount</TD>
		<TD><input size="20" type="text" name="Amnt" value="<?php echo $amt; ?>"></TD>
		</TR>.
		<TR>
		...
		<TR>
			<TD width="40%">UDF1</TD>
			<TD><input size="20" type="text" name="udf1" value="OTP"></TD>
		</TR>
		<TR>
			<TD width="40%">UDF2</TD>
		...
		<TR>
			<TD width="40%">Token Flag</TD>
			<TD><input size="20" type="text" name="tokenflag"></TD>
		</TR>
		<TR>
			<TD width="40%">Token Number</TD>
			<TD><input size="20" type="text" name="tokenNum"></TD>
		</TR>
	</TABLE> 
	</td></tr></table>
...
<input type=hidden name=currcd value="512" >
