...
if($myObj->getPaymentUrl() !=null && $myObj->getPaymentUrl() !='' && $myObj->getPaymentdebitId() !=null && $myObj->getPaymentdebitId() !='' ){
$url=$myObj->getPaymentUrl()."?PaymentID=".$myObj->getPaymentdebitId();
echo"url->".$url;
header( 'Location:'.$url ) ;

echo"getPaymentId->".$myObj->getPaymentdebitId();
echo"getPaymentUrl->".$myObj->getPaymentUrl();
}
else{
echo"getPaymentId -Else->".$myObj->getPaymentdebitId();
echo"getPaymentUrl -Else->".$myObj->getPaymentUrl();
?>
