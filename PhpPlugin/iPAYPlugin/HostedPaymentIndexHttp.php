...
<table width="100%" height="100%" cellpadding="1" cellspacing="1">
	...
	<tr valign="top">
		<td>
			<FORM name="form1" ACTION="HostedPaymentdetailsHttp.php" METHOD="POST">
			...
			<TABLE border="0">
			    <TBODY>
			        ...
			        <TR>
			            <TD width="23"></TD>
			            <TD width="155" rowspan="5"><img src="images/550d.jpg" height="75%"></TD>
			            <TD></TD>
			        ...
			        <TR>
			            ...
			            <!--<TD align="left" width="53">1.00</TD>-->
			            <TD width="116"></TD>
			            <TD width="29"></TD>
			        </TR>
			        <TR>
					...
					<TR>
			            ...
			            <TD width="155"></TD>
			            <TD></TD>
			            <TD align="right" width="155">Action Type:</TD>
						<TD>
			...
			<option value="12"> 12 - Token De-Registration </option> 
			        ...
			        <td></td>
			            ...
			            <td align="right">Token Flag:</td>
			            <td>
			             <input type="text" name="tokenFlag" align="right">
			            </td>
			            <td align="right">Token Number</td>
			            <td>
			             <input type="text" name="tokenNumber" align="right">
			            </td>
			        </tr>
			        <TR>
			            <TD width="23"></TD>
